...
import com.hyphenate.easeui.widget.chatrow.chatrowimage.EaseChatRowImageLast;
import com.hyphenate.easeui.widget.chatrow.chatrowimage.EaseChatRowImageMid;
import com.hyphenate.easeui.widget.chatrow.chatrowimage.EaseChatRowImagefirst;
...
public class EaseMessageAdapter extends BaseAdapter{
	...
	protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
        ...
        case FILE:
            ...
            break;
        case IMAGE:
			// TODO: 2016/6/24 图片不同样式的处理
			int differentStyleChoose = DifferentStyleChooseUtil.differentStyleChoose(message, position, this);
			Log.d(TAG, "createChatRow: =======adapter==========>"+differentStyleChoose+"position======>"+position);
			switch (differentStyleChoose) {
				case 1:
					chatRow = new EaseChatRowImagefirst(context, message, position, this);
					break;
				case 2:
					chatRow = new EaseChatRowImageMid(context, message, position, this);
					break;
				case 3:
					chatRow = new EaseChatRowImageLast(context, message, position, this);
					break;
			}
			break;
        case VOICE:
