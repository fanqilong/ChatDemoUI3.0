...
public class EaseTitleBar extends RelativeLayout{
    ...
    private RelativeLayout right2Layout;
    private ImageView right2Image;
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        //添加第二个 电话布局 第一个是视频布局
        right2Layout = ((RelativeLayout) findViewById(R.id.right2_layout));
        right2Image = ((ImageView) findViewById(R.id.right2_image));
    ...
    private void parseStyle(Context context, AttributeSet attrs){
        if(attrs != null){
            ...
            //对titleBar的进一步修改
            boolean hasSecondRight = ta.getBoolean(R.styleable.EaseTitleBar_hasSecondRight, false);
            if (hasSecondRight){
                //TODO 设置布局的内容 抽离到attr中进行设置
                right2Image.setImageResource(R.drawable.phone);
            }else {
