 ...
 * image风格的第一种状态
 */
public class EaseChatRowImageLast extends EaseChatRowFile {

    protected PorterShapeImageView imageView;
    private EMImageMessageBody imgBody;

    public EaseChatRowImageLast(Context context, EMMessage message, int position, BaseAdapter adapter) {
        super(context, message, position, adapter);
    }

    @Override
    protected void onInflatView() {
        inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ? R.layout.ease_row_received_picture_last : R.layout.ease_row_sent_picture_last, this);
    }
