...
public class EaseChatRowVideo extends EaseChatRowFile {
    ...
    protected void onFindViewById() {
        imageView = ((PorterShapeImageView) findViewById(R.id.chatting_content_iv));
    ...
    protected void onSetUpView() {
        ...
        //==============================设置不同的shape样式
        // FIXME: 2016/6/24 存在shape设置的错乱的问题   先设置为统一的样式  过后处理
        ...
        switch (differentStyleChoose) {
            case 1:
                if (message.direct() == EMMessage.Direct.SEND) {
                    imageView.setShape(getResources().getDrawable(R.drawable.shape_pic_send_frist));
                } else {
                    imageView.setShape(getResources().getDrawable(R.drawable.shape_pic_received_frist));
                }
                break;
            case 2:
...
//                if (message.direct() == EMMessage.Direct.SEND) {
//
//                    imageView.setShape(getResources().getDrawable(R.drawable.shape_pic_send_mid));
//                } else {
//
//                    imageView.setShape(getResources().getDrawable(R.drawable.shape_pic_received_mid));
//                }
                break;
            case 3:
                if (message.direct() == EMMessage.Direct.SEND) {
...
//                if (message.direct() == EMMessage.Direct.SEND) {
//
//                    imageView.setShape(getResources().getDrawable(R.drawable.shape_pic_send_last));
//                } else {
//
//                    imageView.setShape(getResources().getDrawable(R.drawable.shape_pic_received_last));
//                }
                break;
        }
