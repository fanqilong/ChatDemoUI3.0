...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    //拍照　图片　定位
    protected int[] itemStrings = {R.string.attach_take_pic, R.string.attach_take_pic, R.string.attach_picture, R.string.attach_location};
    protected int[] itemdrawables = {R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector,
            R.drawable.ease_chat_location_selector};
    protected int[] itemIds = {ITEM_TAKE_PICTURE, ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_LOCATION};
    ...
    protected void setUpView() {
        ...
        //　右边的点击是删除的事件　个人的是清空聊天的记录　群组的是进入群组的详情界面
